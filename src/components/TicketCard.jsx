...
const statusConfig = {
  ...
  paused: { label: '暂时挂起', className: 'status-paused', icon: Clock },
  review: { label: '审核中', className: 'status-review', icon: MessageSquare },
  done: { label: '待验收', className: 'status-done', icon: CheckCircle },
  complete: { label: '已关单', className: 'status-complete', icon: CheckCircle },
  deprecated: { label: '已废弃', className: 'status-deprecated', icon: AlertCircle },
